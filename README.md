...
- `sermon-hosted-ops` - inspect Sermon-hosted fleet health, recent host metrics, process snapshots, daemon version status, and recent hosted logs/facets through `sermon.fyi`.
